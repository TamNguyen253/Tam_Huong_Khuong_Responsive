// ============================= show related pro =============================
const relatedProData = products.filter((e) => e.category === "laptop").slice(0, 4);
const relatedPro = document.querySelector("#show-related-pro");

relatedProData.slice(0, 4).forEach((e, index) => {
